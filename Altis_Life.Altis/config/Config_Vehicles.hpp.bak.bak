    ...
    class cop_car {
        ...
        vehicles[] = {
         { "shounka_a3_508gend",{ "life_coplevel", "SCALAR", -1 } },
            { "shounka_a3_audiq7_v2_gendarmerie", { "life_coplevel", "SCALAR", 2 } },
            { "Mrshounka_bmw_gend", { "life_coplevel", "SCALAR", 2 } },
            { "Mrshounka_evox_gend", { "life_coplevel", "SCALAR", 2 } },
            { "Mrshounka_agera_gend_p", { "life_coplevel", "SCALAR", 3 } }
        };
    };
